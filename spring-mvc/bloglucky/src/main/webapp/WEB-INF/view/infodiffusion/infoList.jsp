...
<script type="text/javascript">
	...
	function commonPageSearch(pageIndex, pageSize){
		window.location.href="<%=basePath %>viewInfo/live.html?pageIndex="+pageIndex;
	}
		...
		<div class="row clearfix">
			<div class="col-md-8 column">
				<div class="page-header">
					<h1>
						<span class="glyphicon glyphicon-headphones logoTitle">&nbsp;畅谈人生</span>
					</h1>
				</div>
				...
				<c:forEach items="${page}" var="info"
					...
					<div class="media index_div">
						<div class="media-body">
							<div class="media">
								<a href="#" class="pull-left"><img src="<%=basePath %>img/showImg?fileId=${info.imgUrl }"
